...
void ofApp::update(){
	...
	//We should not release memory of val, because it is managed by sound engine
	
	//Update our smoothed spectrum, by slowly decreasing its values and getting maximum with val
	...
	//Note, the parameters in ofMap's were tuned for best result just for current music track
